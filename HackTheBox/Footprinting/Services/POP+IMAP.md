...
## [Default Configuration](https://academy.hackthebox.com/beta/module/112/section/1073#default-configuration)
...
#### [IMAP Commands](https://academy.hackthebox.com/beta/module/112/section/1073#imap-commands)
...
#### [POP3 Commands](https://academy.hackthebox.com/beta/module/112/section/1073#pop3-commands)
...
## [Dangerous Settings](https://academy.hackthebox.com/beta/module/112/section/1073#dangerous-settings)
...
## [Footprinting the Service](https://academy.hackthebox.com/beta/module/112/section/1073#footprinting-the-service)
...
#### [Nmap](https://academy.hackthebox.com/beta/module/112/section/1073#nmap)

```shell-session
4a6f62@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
...
#### [cURL](https://academy.hackthebox.com/beta/module/112/section/1073#curl)

```shell-session
4a6f62@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
...
```shell-session
4a6f62@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
...
#### [OpenSSL - TLS Encrypted Interaction POP3](https://academy.hackthebox.com/beta/module/112/section/1073#openssl-tls-encrypted-interaction-pop3)

```shell-session
4a6f62@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
CONNECTED(00000003)
...
#### [OpenSSL - TLS Encrypted Interaction IMAP](https://academy.hackthebox.com/beta/module/112/section/1073#openssl-tls-encrypted-interaction-imap)

```shell-session
4a6f62@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
CONNECTED(00000003)
Can't use SSL_get_servername
depth=0 C = US, ST = California, L = Sacramento, O = Inlanefreight, OU = Customer Support, CN = mail1.inlanefreight.htb, emailAddress = cry0l1t3@inlanefreight.htb
verify error:num=18:self signed certificate
