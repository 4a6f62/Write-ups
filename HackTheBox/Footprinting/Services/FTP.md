...
```shell-session
4a6f62@htb[/htb]$ sudo nmap --script-updatedb
...
```shell-session
4a6f62@htb[/htb]$ find / -type f -name ftp* 2>/dev/null | grep scripts
...
```shell-session
4a6f62@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136
...
```shell-session
4a6f62@htb[/htb]$ sudo nmap -sV -p21 -sC -A 10.129.14.136 --script-trace
...
```shell-session
4a6f62@htb[/htb]$ nc -nv 10.129.14.136 21
```

FTP

```shell-session
4a6f62@htb[/htb]$ telnet 10.129.14.136 21
```
...
```shell-session
4a6f62@htb[/htb]$ openssl s_client -connect 10.129.14.136:21 -starttls ftp
