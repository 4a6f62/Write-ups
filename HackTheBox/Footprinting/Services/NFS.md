...
```shell-session
4a6f62@htb[/htb]$ cat /etc/exports 
...
```shell-session
4a6f62@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
4a6f62@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
4a6f62@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
4a6f62@htb[/htb]$ mkdir target-NFS
4a6f62@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
4a6f62@htb[/htb]$ cd target-NFS
4a6f62@htb[/htb]$ tree .
...
```shell-session
4a6f62@htb[/htb]$ cd ..
4a6f62@htb[/htb]$ sudo umount ./target-NFS
```
