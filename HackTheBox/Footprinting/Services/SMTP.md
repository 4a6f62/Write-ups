...
## [Default Configuration](https://academy.hackthebox.com/beta/module/112/section/1072#default-configuration)
...
#### [Default Configuration](https://academy.hackthebox.com/beta/module/112/section/1072#default-configuration-1)

```shell-session
4a6f62@htb[/htb]$ cat /etc/postfix/main.cf | grep -v "#" | sed -r "/^\s*$/d"
...
#### [Telnet - HELO/EHLO](https://academy.hackthebox.com/beta/module/112/section/1072#telnet-heloehlo)

```shell-session
4a6f62@htb[/htb]$ telnet 10.129.14.128 25
...
#### [Telnet - VRFY](https://academy.hackthebox.com/beta/module/112/section/1072#telnet-vrfy)
...
#### [Send an Email](https://academy.hackthebox.com/beta/module/112/section/1072#send-an-email)
...
## [Dangerous Settings](https://academy.hackthebox.com/beta/module/112/section/1072#dangerous-settings)
...
#### [Open Relay Configuration](https://academy.hackthebox.com/beta/module/112/section/1072#open-relay-configuration)
...
## [Footprinting the Service](https://academy.hackthebox.com/beta/module/112/section/1072#footprinting-the-service)
...
#### [Nmap](https://academy.hackthebox.com/beta/module/112/section/1072#nmap)

```shell-session
4a6f62@htb[/htb]$ sudo nmap 10.129.14.128 -sC -sV -p25
...
#### [Nmap - Open Relay](https://academy.hackthebox.com/beta/module/112/section/1072#nmap-open-relay)

```shell-session
4a6f62@htb[/htb]$ sudo nmap 10.129.14.128 -p25 --script smtp-open-relay -v
