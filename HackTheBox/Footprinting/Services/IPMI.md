...
```shell-session
4a6f62@htb[/htb]$ sudo nmap -sU --script ipmi-version -p 623 ilo.inlanfreight.local
...
## Use ipmitool for IPMI enumeration without Metasploit:

 # Install if needed
     apt install ipmitool
     
     # Enumerate users
     ipmitool -I lanplus -H 10.129.42.195 -U "" -P "" user list
     
     # Get cipher suites
     ipmitool -I lanplus -H 10.129.42.195 -C 0 -U "" -P "" chassis status