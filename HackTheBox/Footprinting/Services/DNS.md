...
```shell-session
4a6f62@htb[/htb]$ dig soa www.inlanefreight.com
...
## [Default Configuration](https://academy.hackthebox.com/beta/module/112/section/1069#default-configuration)
...
#### [Local DNS Configuration](https://academy.hackthebox.com/beta/module/112/section/1069#local-dns-configuration)
...
#### [Zone Files](https://academy.hackthebox.com/beta/module/112/section/1069#zone-files)
...
#### [Reverse Name Resolution Zone Files](https://academy.hackthebox.com/beta/module/112/section/1069#reverse-name-resolution-zone-files)
...
## [Dangerous Settings](https://academy.hackthebox.com/beta/module/112/section/1069#dangerous-settings)
...
## [Footprinting the Service](https://academy.hackthebox.com/beta/module/112/section/1069#footprinting-the-service)
...
#### DIG - NS Query
```shell-session
4a6f62@htb[/htb]$ dig ns inlanefreight.htb @10.129.14.128
...
#### DIG - Version Query
```shell-session
4a6f62@htb[/htb]$ dig CH TXT version.bind 10.129.120.85
...
#### DIG - ANY Query
```shell-session
4a6f62@htb[/htb]$ dig any inlanefreight.htb @10.129.14.128
...
```shell-session
4a6f62@htb[/htb]$ dig axfr inlanefreight.htb @10.129.14.128
...
```shell-session
4a6f62@htb[/htb]$ dig axfr internal.inlanefreight.htb @10.129.14.128
...
```shell-session
4a6f62@htb[/htb]$ for sub in $(cat /opt/useful/seclists/Discovery/DNS/subdomains-top1million-110000.txt);do dig $sub.inlanefreight.htb @10.129.14.128 | grep -v ';\|SOA' | sed -r '/^\s*$/d' | grep $sub | tee -a subdomains.txt;done
...
```shell-session
4a6f62@htb[/htb]$ dnsenum --dnsserver 10.129.14.128 --enum -p 0 -s 0 -o subdomains.txt -f /opt/useful/seclists/Discovery/DNS/subdomains-top1million-110000.txt inlanefreight.htb
